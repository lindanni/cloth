<?php
	...
	$result=fetch_all('select * from tshirt order by sale desc limit 5');
	if($_SERVER['REQUEST_METHOD']==='POST'){
		if($_POST['search-text']=='mg小象'||$_POST['search-text']=='MG小象'||$_POST['search-text']=='小象'||$_POST['search-text']=='mg'||$_POST['search-text']=='MG'){
